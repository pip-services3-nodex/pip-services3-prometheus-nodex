        ...
        for (let counter of counters) {
            ...
            switch (counter.type) {
                case pip_services3_components_nodex_1.CounterType.Increment:
                    ...
                    builder += counterName + labels + " " + pip_services3_commons_nodex_1.StringConverter.toString(counter.count) + "\n";
                    break;
                case pip_services3_components_nodex_1.CounterType.Interval:
                    builder += "# TYPE " + counterName + "_max gauge\n";
                    builder += counterName + "_max" + labels + " " + pip_services3_commons_nodex_1.StringConverter.toString(counter.max) + "\n";
                    builder += "# TYPE " + counterName + "_min gauge\n";
                    builder += counterName + "_min" + labels + " " + pip_services3_commons_nodex_1.StringConverter.toString(counter.min) + "\n";
                    builder += "# TYPE " + counterName + "_average gauge\n";
                    builder += counterName + "_average" + labels + " " + pip_services3_commons_nodex_1.StringConverter.toString(counter.average) + "\n";
                    builder += "# TYPE " + counterName + "_count gauge\n";
                    builder += counterName + "_count" + labels + " " + pip_services3_commons_nodex_1.StringConverter.toString(counter.count) + "\n";
                    break;
                case pip_services3_components_nodex_1.CounterType.LastValue:
                    builder += "# TYPE " + counterName + " gauge\n";
                    builder += counterName + labels + " " + pip_services3_commons_nodex_1.StringConverter.toString(counter.last) + "\n";
                    break;
