...
suite('PrometheusCounterConverter', () => {
    test('KnownCounter_Exec_ServiceMetrics_Good', () => {
        ...
        for (let testData of knownCounterExecServiceMetricsGoodTestCases) {
            ...
            let counter1 = new pip_services3_components_nodex_1.Counter(counterName, pip_services3_components_nodex_2.CounterType.Increment);
            counter1.count = 1;
            counter1.time = pip_services3_commons_nodex_1.RandomDateTime.nextDateTime(new Date());
            counters.push(counter1);
            let counter2 = new pip_services3_components_nodex_1.Counter(counterName, pip_services3_components_nodex_2.CounterType.Interval);
            counter2.count = 11;
            counter2.max = 13;
            counter2.min = 3;
            counter2.average = 3.5;
            counter2.time = pip_services3_commons_nodex_1.RandomDateTime.nextDateTime(new Date());
            counters.push(counter2);
            let counter3 = new pip_services3_components_nodex_1.Counter(counterName, pip_services3_components_nodex_2.CounterType.LastValue);
            counter3.last = 2;
            counter3.time = pip_services3_commons_nodex_1.RandomDateTime.nextDateTime(new Date());
            counters.push(counter3);
            let counter4 = new pip_services3_components_nodex_1.Counter(counterName, pip_services3_components_nodex_2.CounterType.Statistics);
            counter4.count = 111;
            counter4.max = 113;
            counter4.min = 13;
            counter4.average = 13.5;
            counter4.time = pip_services3_commons_nodex_1.RandomDateTime.nextDateTime(new Date());
    ...
    test('SingleIncrement_NoLabels', () => {
        let counters = new Array();
        let counter = new pip_services3_components_nodex_1.Counter("MyCounter", pip_services3_components_nodex_2.CounterType.Increment);
        counter.average = 2,
            counter.min = 1,
            counter.max = 3,
            counter.count = 2,
            counter.last = 3,
            counter.time = pip_services3_commons_nodex_1.RandomDateTime.nextDateTime(new Date());
    ...
    test('MultiIncrement_SourceInstance', () => {
        let counters = new Array();
        let counter1 = new pip_services3_components_nodex_1.Counter("MyCounter1", pip_services3_components_nodex_2.CounterType.Increment);
        counter1.count = 2,
            counter1.last = 3,
            counter1.time = pip_services3_commons_nodex_1.RandomDateTime.nextDateTime(new Date());
        counters.push(counter1);
        let counter2 = new pip_services3_components_nodex_1.Counter("MyCounter2", pip_services3_components_nodex_2.CounterType.Increment);
        counter2.count = 5,
            counter2.last = 10,
            counter2.time = pip_services3_commons_nodex_1.RandomDateTime.nextDateTime(new Date());
        counters.push(counter2);
    ...
    test('MultiIncrement_ExecWithOnlyTwo_SourceInstance', () => {
        let counters = new Array();
        let counter1 = new pip_services3_components_nodex_1.Counter("MyCounter1.exec_time", pip_services3_components_nodex_2.CounterType.Increment);
        counter1.count = 2,
            counter1.last = 3,
            counter1.time = pip_services3_commons_nodex_1.RandomDateTime.nextDateTime(new Date());
        counters.push(counter1);
        let counter2 = new pip_services3_components_nodex_1.Counter("MyCounter2.exec_time", pip_services3_components_nodex_2.CounterType.Increment);
        counter2.count = 5,
            counter2.last = 10,
            counter2.time = pip_services3_commons_nodex_1.RandomDateTime.nextDateTime(new Date());
        counters.push(counter2);
    ...
    test('MultiIncrement_Exec_SourceInstance', () => {
        let counters = new Array();
        let counter1 = new pip_services3_components_nodex_1.Counter("MyService1.MyCommand1.exec_time", pip_services3_components_nodex_2.CounterType.Increment);
        counter1.count = 2,
            counter1.last = 3,
            counter1.time = pip_services3_commons_nodex_1.RandomDateTime.nextDateTime(new Date());
        counters.push(counter1);
        let counter2 = new pip_services3_components_nodex_1.Counter("MyService2.MyCommand2.exec_time", pip_services3_components_nodex_2.CounterType.Increment);
        counter2.count = 5,
            counter2.last = 10,
            counter2.time = pip_services3_commons_nodex_1.RandomDateTime.nextDateTime(new Date());
        counters.push(counter2);
    ...
    test('MultiInterval_Exec_SourceInstance', () => {
        let counters = new Array();
        let counter1 = new pip_services3_components_nodex_1.Counter("MyService1.MyCommand1.exec_time", pip_services3_components_nodex_2.CounterType.Interval);
        counter1.min = 1,
            counter1.max = 3,
            counter1.average = 2,
            counter1.count = 2,
            ...
            counter1.time = pip_services3_commons_nodex_1.RandomDateTime.nextDateTime(new Date());
        counters.push(counter1);
        let counter2 = new pip_services3_components_nodex_1.Counter("MyService2.MyCommand2.exec_time", pip_services3_components_nodex_2.CounterType.Interval);
        counter2.min = 2,
            counter2.max = 4,
            counter2.average = 3,
            counter2.count = 5,
    ...
    test('MultiStatistics_Exec_SourceInstance', () => {
        let counters = new Array();
        let counter1 = new pip_services3_components_nodex_1.Counter("MyService1.MyCommand1.exec_time", pip_services3_components_nodex_2.CounterType.Statistics);
        counter1.min = 1,
            counter1.max = 3,
            counter1.average = 2,
            counter1.count = 2,
            ...
            counter1.time = pip_services3_commons_nodex_1.RandomDateTime.nextDateTime(new Date());
        counters.push(counter1);
        let counter2 = new pip_services3_components_nodex_1.Counter("MyService2.MyCommand2.exec_time", pip_services3_components_nodex_2.CounterType.Statistics);
        counter2.min = 2,
            counter2.max = 4,
            counter2.average = 3,
            counter2.count = 5,
    ...
    test('MultiLastValue_Exec_SourceInstance', () => {
        let counters = new Array();
        let counter1 = new pip_services3_components_nodex_1.Counter("MyService1.MyCommand1.exec_time", pip_services3_components_nodex_2.CounterType.LastValue);
        counter1.count = 2,
            counter1.last = 3,
            counter1.time = pip_services3_commons_nodex_1.RandomDateTime.nextDateTime(new Date());
        counters.push(counter1);
        let counter2 = new pip_services3_components_nodex_1.Counter("MyService2.MyCommand2.exec_time", pip_services3_components_nodex_2.CounterType.LastValue);
        counter2.count = 5,
            counter2.last = 10,
            counter2.time = pip_services3_commons_nodex_1.RandomDateTime.nextDateTime(new Date());
        counters.push(counter2);
